...
$shortcode_css = OMFGMOBILEPRO . 'includes/template/groove-theme/shortcode-generator/css/shortcodes.css';
...
<script type="text/javascript" src="<?php echo OMFGMOBILEPRO . "includes/template/groove-theme/shortcode-generator/tinymce/js/column-control.js";?>"></script>
<script type="text/javascript" src="<?php echo OMFGMOBILEPRO . "includes/template/groove-theme/shortcode-generator/tinymce/js/tab-control.js";?>"></script>
...
<script type="text/javascript" src="<?php echo OMFGMOBILEPRO . "includes/template/groove-theme/shortcode-generator/tinymce/js/dialog.js";?>"></script>
