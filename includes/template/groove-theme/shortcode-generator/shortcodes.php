...
class omfgmobilepro_groovetheme_shortcodes{
	
	function omfgmobilepro_groovetheme_shortcodes() {
	...
	function filter_mce_buttons( $buttons ) {
		...
		if ($post_type->description == 'OMFG Mobile Site - Omfg Mobile Groove Theme') {
			...
			array_push( $buttons, '|', 'groove_button');
			return $buttons;
	...
	function filter_mce_external_plugins( $plugins ) {
		...
		if ($post_type->description == 'OMFG Mobile Site - Omfg Mobile Groove Theme') {
       		...
       		$plugins['GrooveThemePlugin'] = $this->plugin_url() . 'tinymce/editor_plugin.js';
       		return $plugins;
	...
	function plugin_url() {
		...
		return OMFGMOBILEPRO . 'includes/template/groove-theme/shortcode-generator/';
	}
...
new omfgmobilepro_groovetheme_shortcodes();
?>
